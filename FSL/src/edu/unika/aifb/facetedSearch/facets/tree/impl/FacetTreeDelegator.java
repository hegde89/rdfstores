...
public class FacetTreeDelegator extends Delegator {
	...
	public List<Node> getChildren(StaticClusterNode father) {

		List<Node> children = new ArrayList<Node>();
		FacetTree tree = m_domain2treeMap.get(father.getDomain());

		if (!(father instanceof SingleValueNode)) {
	...
	public Stack<Edge> getPathFromRoot(StaticClusterNode toNode) {
	...
	public DoubleList getRangeLeaves(String domain, double nodeID) {
	...
	public Node getRangeTop(StaticClusterNode property) {

		StaticClusterNode rangeTop = null;
		...
		for (Node child : children) {
			...
			if (child.isRangeRoot()) {
				...
				rangeTop = (StaticClusterNode) child;
				foundRangeRoot = true;
				break;
			}
		}
