 ...
 * 
 */
public class LiteralList implements Serializable {
	...
	private List<ILiteral> m_activeLiterals;

	public LiteralList() {
		m_literals = new ArrayList<ILiteral>();
		setActiveLiterals(new ArrayList<ILiteral>());
	}
	...
	/**
	 * @return the activeLiterals
	 */
	public List<ILiteral> getActiveLiterals() {
		return m_activeLiterals;
	}
	...
	public Iterator<ILiteral> literalIterator() {
		return m_literals.iterator();
	}
	
	public Iterator<ILiteral> activeLiteralIterator() {
		return m_activeLiterals.iterator();
	}

	/**
	 * @param activeLiterals
	 *            the activeLiterals to set
	 */
	public void setActiveLiterals(List<ILiteral> activeLiterals) {
		m_activeLiterals = activeLiterals;
	}
