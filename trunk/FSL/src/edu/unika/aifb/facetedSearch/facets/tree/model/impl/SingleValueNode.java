 ...
 * 
 */
public class SingleValueNode extends StaticClusterNode implements IFacetValueNode {
	...
	public SingleValueNode(String value) {
		super(value);
		super.setType(NodeType.LEAVE);
	}
	
	/* (non-Javadoc)
	 * @see edu.unika.aifb.facetedSearch.facets.tree.model.impl.Node#getCountFV()
	 */
	@Override
