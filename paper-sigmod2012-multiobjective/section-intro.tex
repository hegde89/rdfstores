...
source lookup and table scan). More precisely, \emph{not the
  composition of views or joins but the selection of source scans is
...
database and data integration research. There, sources are described
...
\item In particular, we propose an optimization framework \dtr{weaken
    it} for Linked Data query processing, which incorporates
