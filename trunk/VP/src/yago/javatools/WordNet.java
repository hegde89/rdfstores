...
public class WordNet implements Serializable {
  ...
  public enum WordType {NOUN,VERB,ADJECTIVE,ADVERB};

  /** Pattern for synset definitions */ //              s  (00001740,1111,'enti',n,111111,11).
  ...
  /** Pattern for relation definitions */ //                hyp    (00001740,00001740).
  ...
  public static class Synset implements Serializable, Comparable<Synset> {
    ...
    public final String toString() {
      String result="Synset #"+id+" ("+getWordType()+"): [";
  ...
  /** Returns the list of synsets that contain a word (do not modify the result)*/
  public List<Synset> synsetsFor(String s) {
    return(word2synsets.get(s));
  }
    ...
    while(s!=null) {
      ...
      while(s!=null && s.charAt(2)-48==type) {
        ...
        if(senseNumber<=sensesPerWord) {
          String word=m.group(WORDGROUP).replace("''", "'").replace(' ','_');
          /*if(Name.isPersonName(word)) {
            word=Name.normalizePersonName(word);
          }*/
          ...
          while(synsets.size()<senseNumber) synsets.add(null);
  ...
  public static void main(String[] argv) throws Exception {    
    ...
    while(true) {
      ...
      for(Synset s : targetSynsets) D.p(s.toSmallString());
    }      
  }
