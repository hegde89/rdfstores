...
public class FacetSingleLinkageClusterBuilder implements IBuilder {
	...
	private void doClustering(FacetTree tree, StaticNode epNode)
		...
		// List<AbstractSingleFacetValue> lits = new
		// ArrayList<AbstractSingleFacetValue>();
		// lits.addAll(m_session.getCache().getObjects4StaticNode(epNode));
		//
		// /*
		// * merge sort: O(nlogn)
		// */
		...
		// */
		// PriorityQueue<ClusterDistance> distanceQueue = new
		// PriorityQueue<ClusterDistance>(
		...
		//
		// ArrayList<ClusterDistance> current_leftDistances = new
		// ArrayList<ClusterDistance>();
		...
		// */
		//
		// PriorityQueue<ClusterDistance> posQueue = new
		// PriorityQueue<ClusterDistance>(
		// FacetEnvironment.DefaultValue.NUM_OF_CHILDREN_PER_NODE - 1,
		// new PositionComparator());
		//
		// for (int i = 0; i <
		// FacetEnvironment.DefaultValue.NUM_OF_CHILDREN_PER_NODE - 1; i++) {
		//
