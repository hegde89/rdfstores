...
public class BrowsingObject extends AbstractObject implements IBrowsingObject {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6900561861821563460L;
	private String m_sourceExtension;

	public BrowsingObject(SearchSession session, String value, String extension) {
		super(value, extension);
		super.setSession(session);
	}

	public BrowsingObject(String value, String extension) {
		super(value, extension);
	}
	 ...
	 * 
	 * @see
	 * edu.unika.aifb.facetedSearch.api.model.IBrowsingObject#getSourceExtension
	 * ()
	 */
	 ...
	 * 
	 * @see
	 * edu.unika.aifb.facetedSearch.api.model.IBrowsingObject#setSourceExtension
	 * ()
	 */
