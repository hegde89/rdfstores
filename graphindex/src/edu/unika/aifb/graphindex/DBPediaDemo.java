...
public class DBPediaDemo {
	...
	public static void main(String[] args) throws Exception {
		...
		if (action.equals("test")) {
			...
			Table<String> table = di.getQuads(null, "http://dbpedia.org/ontology/type", null, null);
			...
			q.addEdge("?x", "http://dbpedia.org/ontology/type", "http://dbpedia.org/resource/High_school");
			q.addEdge("?x", "http://xmlns.com/foaf/0.1/name", "?y");
			...
			KeywordQuery kq = new KeywordQuery("q1", "William School");
