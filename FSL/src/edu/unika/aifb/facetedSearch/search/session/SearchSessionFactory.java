...
public class SearchSessionFactory {
	...
	public static class SearchSessionFactoryUtils {

		public static boolean isExpired(int sessionId) {
	...
	public static int[] getLocks() {
		return s_locks;
	}
	public static SearchSession[] getPool() {
		return s_pool;
	}
	...
	private void readProperties(Properties props) {
		...
		FacetedSearchLayerConfig
				.setFacetIdxDirStrg(props
						.getProperty(FacetedSearchLayerConfig.Property.FACET_INDEX_DIR));

		FacetedSearchLayerConfig
				.setFacetsEnabled(new Boolean(
						props
								.getProperty(FacetedSearchLayerConfig.Property.FACETS_ENABLED)));

		FacetedSearchLayerConfig
				.setRankingEnabled(new Boolean(
						props
								.getProperty(FacetedSearchLayerConfig.Property.RANKING_ENABLED)));

		FacetedSearchLayerConfig.setExpressivity(props
				.getProperty(FacetedSearchLayerConfig.Property.EXPRESSIVITY));

		FacetedSearchLayerConfig
				.setCreateFacetIdx(new Boolean(
						props
								.getProperty(FacetedSearchLayerConfig.Property.CREATE_FACET_IDX)));

		FacetedSearchLayerConfig
				.setCreateGraphIdx(new Boolean(
						props
								.getProperty(FacetedSearchLayerConfig.Property.CREATE_GRAPH_IDX)));

		FacetedSearchLayerConfig.setCacheDirStrg((props
				.getProperty(FacetedSearchLayerConfig.Property.CACHE_DIR)));

		FacetedSearchLayerConfig
				.setGraphIndexDirStrg((props
						.getProperty(FacetedSearchLayerConfig.Property.GRAPH_INDEX_DIR)));

		FacetedSearchLayerConfig
				.setPreloadMaxBytes(Long
						.parseLong(props
								.getProperty(FacetedSearchLayerConfig.Property.PRELOAD_MAX_BYTES)));

		FacetedSearchLayerConfig.setCacheConfigDirStrg(props
				.getProperty(FacetedSearchLayerConfig.Property.CACHE_CONFIG));

		FacetedSearchLayerConfig
				.setMaxSearchSessions(Integer
						.parseInt(props
								.getProperty(FacetedSearchLayerConfig.Property.MAX_SEARCH_SESSIONS)));

		FacetedSearchLayerConfig
				.setMaxSearchSessionLength(Long
						.parseLong(props
								.getProperty(FacetedSearchLayerConfig.Property.MAX_SEARCH_LENGTH)));

		FacetedSearchLayerConfig
				.setCleaningInterval(Long
						.parseLong(props
								.getProperty(FacetedSearchLayerConfig.Property.CLEANING_INTERVAL)));

		FacetedSearchLayerConfig.setRankingMetric(props
				.getProperty(FacetedSearchLayerConfig.Property.RANKING_METRIC));

		FacetedSearchLayerConfig.setClusterer(props
				.getProperty(FacetedSearchLayerConfig.Property.CLUSTERER));

		FacetedSearchLayerConfig
				.setRefinementMode(props
						.getProperty(FacetedSearchLayerConfig.Property.REFINEMENT_MODE));
	...
	public void release(int id, String httpSessionId) {
		...
		if ((s_pool[id].getHttpSessionId() != null)
				&& s_pool[id].getHttpSessionId().equals(httpSessionId)) {
